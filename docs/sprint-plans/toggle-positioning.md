...
**Status:** SUPERSEDED — never executed. The next day's [expanding-toggle plan](./expanding-toggle.md) replaced the pill switch outright instead of repositioning it.
**Created:** 2026-06-01
**Base branch:** main
...
- 2026-06-01: Revised to clamp the toggle position and accept residual overlap as best-efforts.
- 2026-06-02: Superseded before execution. The expanding-toggle plan rejected the fixed shift (its residual risks are not solvable by repositioning) and replaced the pill switch with the expanding dot. No sprint from this plan ran.
