...
| Package | Job |
|---------|-----|
| `defaults.js` | Every shared constant, loaded by all three contexts: the settings contract (each option's name and default) and every cross-context topic name |
