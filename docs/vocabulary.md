...
| data table        | A table becomes a '**data table**' when it has  at least two rows, a row with two or more cells, and at least one cell that parses as a number.<br><br>Only data tables enter the registry, get a pillbox, and can be bound to the sidebar.<br>                                                                                                                                                                                                                                                                                                   |
